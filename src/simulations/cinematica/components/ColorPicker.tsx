    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-64 p-4" align="start">
        <div className="space-y-4">
          ...
          <div>
            <p className="text-sm font-medium mb-3">Colores predefinidos</p>
          ...
          <div>
            <p className="text-sm font-medium mb-3">Color personalizado</p>
            ...
            {!isValidHexColor(customColor) && customColor !== "" && (
              <p className="text-xs text-red-500 mt-1">
                Formato de color inválido. Use formato hex (#000000)
              </p>
            )}
          </div>
