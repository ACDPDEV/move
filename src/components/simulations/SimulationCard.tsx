      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-12">
        ...
        {showBackButton && (
          <div className="mb-6 sm:mb-8">
            ...
            >
              <IconArrowLeft className="w-4 h-4 mr-2 group-hover:-translate-x-1 transition-transform" />
              <span className="text-sm sm:text-base">Volver a simuladores</span>
            </Link>
          </div>
        )}
                ...
                <div className="space-y-3">
                  {simulation.isAvaible ? (
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Link href={simulation.playLink} className="flex-1">
                        <Button 
                          size="lg" 
                        ...
                        >
                          ...
                          <span className="text-sm sm:text-base">Iniciar simulación</span>
                          <IconExternalLink className="w-3 h-3 sm:w-4 sm:h-4 ml-2" />
                        </Button>
                      </Link>
                      <Link href={simulation.previewLink} className="flex-1">
                        <Button 
                          variant="outline" 
                          size="lg" 
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <span className="text-sm sm:text-base">Próximamente disponible</span>
                      </Button>
                    ...
                    <div className="space-y-2 xl:space-y-3">
                      {simulation.isAvaible ? (
                        <div className="flex flex-col gap-3">
                          <Link href={simulation.playLink}>
                            ...
                            >
                              ...
                              <span className="hidden xl:inline">Iniciar simulación</span>
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            <IconClock className="w-4 h-4 mr-2" />
                            <span className="hidden xl:inline">Próximamente disponible</span>
                            <span className="xl:hidden">Próximamente</span>
                          </Button>
            ...
            <Card className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-0 shadow-xl">
              <CardHeader className="pb-3 xl:pb-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-base xl:text-lg font-semibold text-slate-900 dark:text-slate-100">Detalles</h3>
                  <div className="flex gap-1">
                    <Button variant="ghost" size="sm" className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 h-8 w-8 p-0">
        ...
        <div className="mt-6 lg:mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-0 shadow-xl">
            <CardHeader className="pb-3 lg:pb-4">
              <h3 className="text-lg lg:text-xl font-semibold text-slate-900 dark:text-slate-100">Características</h3>
            </CardHeader>
          ...
          <Card className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-0 shadow-xl">
            <CardHeader className="pb-3 lg:pb-4">
              <h3 className="text-lg lg:text-xl font-semibold text-slate-900 dark:text-slate-100">Acerca de este simulador</h3>
            </CardHeader>
            <CardContent className="pt-0">
