...
function Hero() {
    return (
        <section className="relative w-full h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center z-5">
            ...
            <div className="absolute -top-14 w-screen h-screen -z-10 bg-[#131217]" />
            ...
            <Line className="absolute top-0 bottom-0 left-0 right-0 w-full h-full -z-1 animate-fade-in animate-duration-[1.4s] pointer-events-none" />
            <img
                src="/Stars.avif"
                alt="stars"
            ...
            />
            <div className="absolute bottom-0 w-screen h-[calc(100vh/4)] bg-gradient-to-t from-[#151618] to-[#131217] -z-9 pointer-events-none" />
        </section>
    );
}
